...
u = BlzCreateUnitWithSkin(p, FourCC("Ocb2"), 2856.1, 8837.5, 267.020, FourCC("Ocb2"))
...
u = BlzCreateUnitWithSkin(p, FourCC("esen"), 2277.9, 9934.0, 51.670, FourCC("esen"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("earc"), 2308.2, 9617.4, 93.870, FourCC("earc"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("efdr"), 4013.3, 10762.2, 236.510, FourCC("efdr"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("ogru"), 2125.9, 9870.8, 4.274, FourCC("ogru"))
SetUnitAcquireRange(u, 200.0)
...
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("ocat"), 1961.5, 9833.3, 195.376, FourCC("ocat"))
SetUnitAcquireRange(u, 200.0)
...
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("odoc"), 2111.9, 9823.1, 59.756, FourCC("odoc"))
SetUnitAcquireRange(u, 200.0)
...
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("oshm"), 2297.0, 9703.6, 32.795, FourCC("oshm"))
SetUnitAcquireRange(u, 200.0)
...
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("ospw"), 2161.5, 9579.1, 272.821, FourCC("ospw"))
SetUnitAcquireRange(u, 200.0)
...
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("hkni"), 2063.7, 9854.4, 258.890, FourCC("hkni"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("nitt"), 11280.1, -6525.7, 148.821, FourCC("nitt"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("hrif"), 2332.4, 9767.2, 298.936, FourCC("hrif"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("hmtm"), 2295.9, 9867.1, 351.738, FourCC("hmtm"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("hpea"), 2178.0, 9890.1, 237.213, FourCC("hpea"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("hmpr"), 2284.7, 9985.5, 291.586, FourCC("hmpr"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("hsor"), 2299.7, 9731.7, 259.384, FourCC("hsor"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("hmtt"), 1921.5, 9952.9, 167.777, FourCC("hmtt"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("hspt"), 2082.3, 9705.3, 91.717, FourCC("hspt"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("uaco"), 2272.5, 9820.1, 154.132, FourCC("uaco"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("ugho"), 2339.2, 9915.4, 121.622, FourCC("ugho"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("uabo"), 2379.2, 9846.6, 267.778, FourCC("uabo"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("umtw"), 2197.4, 9966.6, 351.694, FourCC("umtw"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("ucry"), 2463.6, 9730.6, 259.780, FourCC("ucry"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("uban"), 2149.0, 9819.1, 112.394, FourCC("uban"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("unec"), 2145.6, 9818.8, 19.545, FourCC("unec"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("uobs"), 2454.0, 10135.6, 250.551, FourCC("uobs"))
SetUnitAcquireRange(u, 200.0)
...
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("ebal"), 2463.7, 9906.3, 174.150, FourCC("ebal"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("edry"), 2065.3, 10003.6, 36.827, FourCC("edry"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("edot"), 2305.7, 9668.9, 134.147, FourCC("edot"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("edoc"), 2244.0, 9644.8, 105.022, FourCC("edoc"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("emtg"), 2156.8, 9676.0, 273.172, FourCC("emtg"))
SetUnitAcquireRange(u, 200.0)
u = BlzCreateUnitWithSkin(p, FourCC("efdr"), 1937.9, 9736.1, 236.510, FourCC("efdr"))
SetUnitAcquireRange(u, 200.0)
end
...
SetUnitColor(u, ConvertPlayerColor(3))
u = BlzCreateUnitWithSkin(p, FourCC("nwgt"), 3264.0, 5184.0, 270.000, FourCC("nwgt"))
WaygateSetDestination(u, GetRectCenterX(gg_rct_Top_Left), GetRectCenterY(gg_rct_Top_Left))
WaygateActivate(u, true)
SetUnitColor(u, ConvertPlayerColor(0))
u = BlzCreateUnitWithSkin(p, FourCC("nwgt"), 3264.0, 4544.0, 270.000, FourCC("nwgt"))
WaygateSetDestination(u, GetRectCenterX(gg_rct_Bottom_Left), GetRectCenterY(gg_rct_Bottom_Left))
WaygateActivate(u, true)
SetUnitColor(u, ConvertPlayerColor(0))
u = BlzCreateUnitWithSkin(p, FourCC("nwgt"), 3904.0, 4544.0, 270.000, FourCC("nwgt"))
WaygateSetDestination(u, GetRectCenterX(gg_rct_Bottom_Right), GetRectCenterY(gg_rct_Bottom_Right))
WaygateActivate(u, true)
SetUnitColor(u, ConvertPlayerColor(0))
u = BlzCreateUnitWithSkin(p, FourCC("nwgt"), -7680.0, 9664.0, 270.000, FourCC("nwgt"))
WaygateSetDestination(u, GetRectCenterX(gg_rct_Top_Right), GetRectCenterY(gg_rct_Top_Right))
WaygateActivate(u, true)
SetUnitColor(u, ConvertPlayerColor(0))
u = BlzCreateUnitWithSkin(p, FourCC("nwgt"), -7424.0, -10176.0, 270.000, FourCC("nwgt"))
WaygateSetDestination(u, GetRectCenterX(gg_rct_Top_Right), GetRectCenterY(gg_rct_Top_Right))
WaygateActivate(u, true)
SetUnitColor(u, ConvertPlayerColor(0))
u = BlzCreateUnitWithSkin(p, FourCC("nwgt"), 7488.0, -9088.0, 270.000, FourCC("nwgt"))
WaygateSetDestination(u, GetRectCenterX(gg_rct_Top_Right), GetRectCenterY(gg_rct_Top_Right))
WaygateActivate(u, true)
SetUnitColor(u, ConvertPlayerColor(0))
u = BlzCreateUnitWithSkin(p, FourCC("nfoh"), 7936.0, 6976.0, 270.000, FourCC("nfoh"))
u = BlzCreateUnitWithSkin(p, FourCC("nmoo"), 8320.0, 6976.0, 270.000, FourCC("nmoo"))
...
SetResourceAmount(u, 1000000)
u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 6592.0, -640.0, 270.000, FourCC("ngol"))
SetResourceAmount(u, 1000000)
...
gg_rct_Yellow_Top = Rect(-512.0, 4992.0, 128.0, 5728.0)
gg_rct_Red_Right = Rect(8192.0, -896.0, 8960.0, -128.0)
gg_rct_Yellow_Bottom = Rect(-1184.0, -7808.0, -448.0, -7072.0)
gg_rct_Red_Left = Rect(-9440.0, -800.0, -8896.0, -192.0)
gg_rct_Top_Left = Rect(-7872.0, 9440.0, -7456.0, 9952.0)
gg_rct_Bottom_Left = Rect(-7616.0, -10400.0, -7200.0, -9888.0)
gg_rct_Bottom_Right = Rect(7296.0, -9344.0, 7712.0, -8832.0)
gg_rct_Top_Right = Rect(3072.0, 4352.0, 4128.0, 5504.0)
end
...
function Trig_Initialization_Func020001002()
return (GetUnitTypeId(GetFilterUnit()) == FourCC("nwgt"))
end

function Trig_Initialization_Func020A()
CreateUbersplatBJ(GetUnitLoc(GetEnumUnit()), "SCTP", 100, 100, 100, 0, false, false)
ShowUbersplatBJ(true, GetLastCreatedUbersplat())
SetUbersplatRender(GetLastCreatedUbersplat(), true)
SetUbersplatRenderAlways(GetLastCreatedUbersplat(), true)
ResetUbersplat(GetLastCreatedUbersplat())
end
...
MeleeStartingAI()
ForGroupBJ(GetUnitsInRectMatching(GetPlayableMapRect(), Condition(Trig_Initialization_Func020001002)), Trig_Initialization_Func020A)
end
...
DefineStartLocation(3, -512.0, -5312.0)
DefineStartLocation(4, 6144.0, 8064.0)
DefineStartLocation(5, -2176.0, -3008.0)
DefineStartLocation(6, 8960.0, -9344.0)
DefineStartLocation(7, -9088.0, -9600.0)
DefineStartLocation(8, -8576.0, 8704.0)
DefineStartLocation(9, -6400.0, -7040.0)
DefineStartLocation(10, 6016.0, -832.0)
DefineStartLocation(11, 6208.0, 5632.0)
DefineStartLocation(12, 8768.0, -6464.0)
DefineStartLocation(13, -5504.0, -9856.0)
...
DefineStartLocation(18, -9088.0, -6400.0)
