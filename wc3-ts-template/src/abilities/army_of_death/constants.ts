...
export const FOLLOW_MOVEMENT_SPEED = 400;

export const REVIVED_RED = 64;
export const REVIVED_GREEN = 64;
export const REVIVED_BLUE = 64;
export const REVIVED_ALPHA = 200;
