...
SetResourceAmount(u, 56000)
u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 1856.0, 832.0, 270.000, FourCC("ngol"))
SetResourceAmount(u, 56000)
...
TriggerRegisterAnyUnitEventBJ(gg_trg_Untitled_Trigger_001, EVENT_PLAYER_UNIT_DAMAGED)
