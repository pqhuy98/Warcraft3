...
u = BlzCreateUnitWithSkin(p, FourCC("hctw"), 128.0, 512.0, 270.000, FourCC("hctw"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hbar"), 0.0, 1344.0, 270.000, FourCC("hbar"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hhou"), 64.0, 384.0, 270.000, FourCC("hhou"))
u = BlzCreateUnitWithSkin(p, FourCC("hhou"), 192.0, 384.0, 270.000, FourCC("hhou"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hbar"), 320.0, 768.0, 270.000, FourCC("hbar"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("hctw"), 576.0, -2368.0, 270.000, FourCC("hctw"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hbar"), 192.0, -1536.0, 270.000, FourCC("hbar"))
u = BlzCreateUnitWithSkin(p, FourCC("hatw"), 0.0, -1920.0, 270.000, FourCC("hatw"))
u = BlzCreateUnitWithSkin(p, FourCC("hgtw"), 1024.0, -640.0, 270.000, FourCC("hgtw"))
u = BlzCreateUnitWithSkin(p, FourCC("harm"), 896.0, -1920.0, 270.000, FourCC("harm"))
u = BlzCreateUnitWithSkin(p, FourCC("hbla"), 1216.0, -2048.0, 270.000, FourCC("hbla"))
u = BlzCreateUnitWithSkin(p, FourCC("hars"), 1472.0, -576.0, 270.000, FourCC("hars"))
u = BlzCreateUnitWithSkin(p, FourCC("hhou"), 1088.0, -512.0, 270.000, FourCC("hhou"))
u = BlzCreateUnitWithSkin(p, FourCC("hvlt"), 640.0, -768.0, 270.000, FourCC("hvlt"))
u = BlzCreateUnitWithSkin(p, FourCC("hhou"), 960.0, -512.0, 270.000, FourCC("hhou"))
...
u = BlzCreateUnitWithSkin(p, FourCC("hbar"), 448.0, -2048.0, 270.000, FourCC("hbar"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("otto"), -960.0, -1792.0, 270.000, FourCC("otto"))
u = BlzCreateUnitWithSkin(p, FourCC("owtw"), -1920.0, -1408.0, 270.000, FourCC("owtw"))
...
u = BlzCreateUnitWithSkin(p, FourCC("ofor"), -2272.0, -1440.0, 270.000, FourCC("ofor"))
...
u = BlzCreateUnitWithSkin(p, FourCC("osld"), -1408.0, -2112.0, 270.000, FourCC("osld"))
u = BlzCreateUnitWithSkin(p, FourCC("obar"), -1472.0, -832.0, 270.000, FourCC("obar"))
...
u = BlzCreateUnitWithSkin(p, FourCC("obea"), -2112.0, 256.0, 270.000, FourCC("obea"))
u = BlzCreateUnitWithSkin(p, FourCC("obar"), -768.0, 1344.0, 270.000, FourCC("obar"))
u = BlzCreateUnitWithSkin(p, FourCC("owtw"), -1856.0, 832.0, 270.000, FourCC("owtw"))
...
u = BlzCreateUnitWithSkin(p, FourCC("otto"), -1536.0, 192.0, 270.000, FourCC("otto"))
u = BlzCreateUnitWithSkin(p, FourCC("owtw"), -1472.0, -192.0, 270.000, FourCC("owtw"))
u = BlzCreateUnitWithSkin(p, FourCC("osld"), -832.0, 832.0, 270.000, FourCC("osld"))
u = BlzCreateUnitWithSkin(p, FourCC("otrb"), -1632.0, -160.0, 270.000, FourCC("otrb"))
u = BlzCreateUnitWithSkin(p, FourCC("otrb"), -1696.0, 736.0, 270.000, FourCC("otrb"))
u = BlzCreateUnitWithSkin(p, FourCC("otrb"), -480.0, 992.0, 270.000, FourCC("otrb"))
u = BlzCreateUnitWithSkin(p, FourCC("ovln"), -960.0, 64.0, 270.000, FourCC("ovln"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("opeo"), -1714.0, 962.3, 95.694, FourCC("opeo"))
u = BlzCreateUnitWithSkin(p, FourCC("opeo"), -1640.1, 905.7, 223.743, FourCC("opeo"))
u = BlzCreateUnitWithSkin(p, FourCC("opeo"), -1658.9, 1012.9, 272.810, FourCC("opeo"))
end
...
SetHeroLevel(gg_unit_H002_0191, 4, false)
...
SetHeroLevel(gg_unit_Othr_0324, 4, false)
...
gg_unit_Osam_0326 = BlzCreateUnitWithSkin(p, FourCC("Osam"), -1589.3, -1767.0, 7.640, FourCC("Osam"))
SetHeroLevel(gg_unit_Osam_0326, 10, false)
...
SetHeroLevel(gg_unit_Hjai_0327, 4, false)
...
gg_unit_nfoh_0321 = BlzCreateUnitWithSkin(p, FourCC("nfoh"), -9280.0, 8192.0, 270.000, FourCC("nbfl"))
u = BlzCreateUnitWithSkin(p, FourCC("nfoh"), 1216.0, -9856.0, 270.000, FourCC("nbfl"))
u = BlzCreateUnitWithSkin(p, FourCC("nfoh"), 8192.0, -8960.0, 270.000, FourCC("nbfl"))
u = BlzCreateUnitWithSkin(p, FourCC("nfoh"), -3520.0, 9664.0, 270.000, FourCC("nbfl"))
u = BlzCreateUnitWithSkin(p, FourCC("nfoh"), -9472.0, 2624.0, 270.000, FourCC("nbfl"))
u = BlzCreateUnitWithSkin(p, FourCC("nfoh"), 9792.0, -3008.0, 270.000, FourCC("nbfl"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("uabo"), -770.1, 2730.1, 246.387, FourCC("uabo"))
gg_unit_H001_0320 = BlzCreateUnitWithSkin(p, FourCC("H001"), -496.1, 3140.3, 274.692, FourCC("H001"))
...
gg_unit_U000_0322 = BlzCreateUnitWithSkin(p, FourCC("U000"), -8934.1, 8174.7, 204.198, FourCC("U000"))
SetHeroLevel(gg_unit_U000_0322, 3, false)
SetUnitState(gg_unit_U000_0322, UNIT_STATE_MANA, 210)
u = BlzCreateUnitWithSkin(p, FourCC("uabo"), -574.3, 2738.2, 285.335, FourCC("uabo"))
u = BlzCreateUnitWithSkin(p, FourCC("uabo"), 54.9, 2842.5, 234.236, FourCC("uabo"))
u = BlzCreateUnitWithSkin(p, FourCC("uabo"), -252.0, 2773.5, 318.053, FourCC("uabo"))
u = BlzCreateUnitWithSkin(p, FourCC("uabo"), -374.7, 2770.0, 210.999, FourCC("uabo"))
u = BlzCreateUnitWithSkin(p, FourCC("uabo"), -649.6, 2541.2, 22.292, FourCC("uabo"))
u = BlzCreateUnitWithSkin(p, FourCC("uabo"), -398.3, 2558.2, 308.527, FourCC("uabo"))
u = BlzCreateUnitWithSkin(p, FourCC("uabo"), -174.0, 2586.7, 130.390, FourCC("uabo"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("nltc"), -9441.8, 2163.9, 320.313, FourCC("nltc"))
...
u = BlzCreateUnitWithSkin(p, FourCC("nlsn"), -6548.1, 4349.3, 311.164, FourCC("nlsn"))
u = BlzCreateUnitWithSkin(p, FourCC("nltc"), -6701.6, 4530.7, 311.036, FourCC("nltc"))
u = BlzCreateUnitWithSkin(p, FourCC("nlds"), -6574.1, 4714.0, 304.074, FourCC("nlds"))
t = CreateTrigger()
TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
TriggerAddAction(t, Unit000386_DropItems)
u = BlzCreateUnitWithSkin(p, FourCC("nlkl"), -6376.3, 4623.0, 300.044, FourCC("nlkl"))
t = CreateTrigger()
TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
TriggerAddAction(t, Unit000387_DropItems)
u = BlzCreateUnitWithSkin(p, FourCC("nltc"), -6380.4, 4312.8, 306.812, FourCC("nltc"))
...
function InitUpgrades_Player12()
SetPlayerTechResearched(Player(12), FourCC("Rume"), 3)
SetPlayerTechResearched(Player(12), FourCC("Rura"), 3)
SetPlayerTechResearched(Player(12), FourCC("Ruar"), 3)
SetPlayerTechResearched(Player(12), FourCC("Ruac"), 1)
SetPlayerTechResearched(Player(12), FourCC("Rugf"), 1)
SetPlayerTechResearched(Player(12), FourCC("Ruwb"), 1)
SetPlayerTechResearched(Player(12), FourCC("Rusf"), 1)
SetPlayerTechResearched(Player(12), FourCC("Rune"), 2)
SetPlayerTechResearched(Player(12), FourCC("Ruba"), 2)
SetPlayerTechResearched(Player(12), FourCC("Rufb"), 1)
SetPlayerTechResearched(Player(12), FourCC("Rucr"), 3)
SetPlayerTechResearched(Player(12), FourCC("Rusl"), 1)
SetPlayerTechResearched(Player(12), FourCC("Rupc"), 1)
SetPlayerTechResearched(Player(12), FourCC("Rusm"), 1)
SetPlayerTechResearched(Player(12), FourCC("Rubu"), 1)
SetPlayerTechResearched(Player(12), FourCC("Rusp"), 1)
SetPlayerTechResearched(Player(12), FourCC("Ruex"), 1)
SetPlayerTechMaxAllowed(Player(12), FourCC("Rupm"), 0)
end
...
SetStartLocPrio(2, 2, 11, MAP_LOC_PRIO_LOW)
SetStartLocPrio(2, 3, 12, MAP_LOC_PRIO_LOW)
SetEnemyStartLocPrioCount(2, 3)
SetEnemyStartLocPrio(2, 0, 4, MAP_LOC_PRIO_HIGH)
SetEnemyStartLocPrio(2, 1, 11, MAP_LOC_PRIO_LOW)
SetEnemyStartLocPrio(2, 2, 12, MAP_LOC_PRIO_LOW)
...
SetStartLocPrio(4, 9, 12, MAP_LOC_PRIO_HIGH)
SetEnemyStartLocPrioCount(4, 9)
SetEnemyStartLocPrio(4, 0, 1, MAP_LOC_PRIO_HIGH)
SetEnemyStartLocPrio(4, 1, 3, MAP_LOC_PRIO_LOW)
SetEnemyStartLocPrio(4, 2, 5, MAP_LOC_PRIO_LOW)
SetEnemyStartLocPrio(4, 3, 6, MAP_LOC_PRIO_LOW)
SetEnemyStartLocPrio(4, 4, 7, MAP_LOC_PRIO_LOW)
SetEnemyStartLocPrio(4, 5, 8, MAP_LOC_PRIO_LOW)
SetEnemyStartLocPrio(4, 6, 9, MAP_LOC_PRIO_HIGH)
SetEnemyStartLocPrio(4, 7, 10, MAP_LOC_PRIO_LOW)
SetEnemyStartLocPrio(4, 8, 12, MAP_LOC_PRIO_LOW)
...
SetEnemyStartLocPrio(6, 0, 4, MAP_LOC_PRIO_LOW)
...
SetEnemyStartLocPrio(7, 0, 4, MAP_LOC_PRIO_HIGH)
...
SetEnemyStartLocPrio(12, 0, 4, MAP_LOC_PRIO_LOW)
end
...
DefineStartLocation(2, 768.0, -1344.0)
DefineStartLocation(3, -1472.0, -1344.0)
DefineStartLocation(4, -1280.0, 640.0)
DefineStartLocation(5, 12224.0, 11712.0)
DefineStartLocation(6, 12160.0, 11584.0)
DefineStartLocation(7, -9536.0, 7424.0)
DefineStartLocation(8, -4288.0, 9408.0)
DefineStartLocation(9, 1792.0, -9792.0)
DefineStartLocation(10, 7552.0, -9216.0)
DefineStartLocation(11, 9600.0, -3904.0)
DefineStartLocation(12, -9472.0, 1984.0)
